...
public class JwtHelper {
    ...
    // Your secret key (Make sure it's of appropriate length for HS512, at least 256
    // bits)
    ...
    private Claims getAllClaimsFromToken(String token) {
        SecretKey key = Keys.hmacShaKeyFor(secret.getBytes()); // Generate key from the secret
